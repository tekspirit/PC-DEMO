...
BOOL CMainFrame::OnCreateClient(LPCREATESTRUCT lpcs, CCreateContext* pContext) 
{
	...
	m_scrollsize[0].cx=screen.cx/4;m_scrollsize[0].cy=screen.cy;
	m_scrollsize[1].cx=screen.cx/2;m_scrollsize[1].cy=screen.cy;
	m_scrollsize[2].cx=screen.cx/4;m_scrollsize[2].cy=screen.cy;
